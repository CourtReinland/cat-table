...
Living SOP (GS-SOP-1; supersedes the metaball paragraph below): [`docs/sop/README.md`](docs/sop/README.md) and the Steph cat playbook [`tools/character-pipe/SOP.md`](tools/character-pipe/SOP.md).
